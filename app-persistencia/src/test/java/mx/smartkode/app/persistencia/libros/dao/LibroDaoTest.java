package mx.smartkode.app.persistencia.libros.dao;
...
public class LibroDaoTest {
	...
	private static Logger log = Logger.getLogger(LibroDaoTest.class);
	
	@Autowired
	private LibroDao libroDao;
		
	@Test
	public void getLibrosTituloContainingTest() {
		assertNotNull(libroDao);
		try {
			
			List<GcLibro> libros = libroDao.findByTituloContaining("");
			for (GcLibro libro : libros) {
